            ...
            <form action="#" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="number" id="kuantitas" name="kuantitas" min="0" placeholder="0" 
                            class="w-full border-gray-300 rounded-xl shadow-sm focus:border-[#588133] focus:ring focus:ring-[#588133] focus:ring-opacity-50" required>
                    </div>
                    <div>
                ...
                <div class="flex items-center justify-end gap-4 border-t border-gray-100 pt-6">
                    <a href="#" class="text-gray-500 hover:text-gray-700 text-sm font-medium transition duration-150">
                        Batal
                    </a>
