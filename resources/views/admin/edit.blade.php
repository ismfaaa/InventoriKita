<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            <a href="{{ route('admin.index') }}" class="text-gray-400 hover:text-[#588133] transition">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-3xl border border-gray-100 p-8">
            <form action="#" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="kode_barang" name="kode_barang" value="CAM-001" 
                        class="w-full border-gray-300 rounded-xl shadow-sm focus:border-[#588133] focus:ring focus:ring-[#588133] focus:ring-opacity-50 bg-gray-50" readonly>
                    <p class="mt-1 text-xs text-gray-400">Kode barang tidak dapat diubah.</p>
                </div>

                <div class="mb-6">
                    <label for="nama_barang" class="block font-medium text-sm text-gray-700 mb-2">Nama Barang <span class="text-red-500">*</span></label>
                    <input type="text" id="nama_barang" name="nama_barang" value="Kamera Sony A6400" 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        <label for="kuantitas" class="block font-medium text-sm text-gray-700 mb-2">Kuantitas / Stok <span class="text-red-500">*</span></label>
                        <input type="number" id="kuantitas" name="kuantitas" min="0" value="5" 
                            class="w-full border-gray-300 rounded-xl shadow-sm focus:border-[#588133] focus:ring focus:ring-[#588133] focus:ring-opacity-50" required>
                    </div>
                    <div>
                        ...
                        <input type="text" id="lokasi" name="lokasi" value="Lemari A, Rak 2" 
                            class="w-full border-gray-300 rounded-xl shadow-sm focus:border-[#588133] focus:ring focus:ring-[#588133] focus:ring-opacity-50" required>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <p class="mt-2 text-xs text-gray-400">Format: JPG, PNG. Maksimal 2MB. Biarkan kosong jika tidak ingin mengganti foto.</p>
                </div>

                <div class="flex items-center justify-end gap-4 border-t border-gray-100 pt-6">
                    <a href="{{ route('admin.index') }}" class="text-gray-500 hover:text-gray-700 text-sm font-medium transition duration-150">
                        Batal
                    </a>
